    ...
    <header class="navbar-section">
        <nav class="navbar navbar-expand-lg">
            <div class="container-fluid">
                <a class="navbar-brand" href="#"><i class="bi bi-chat"></i> Febtech IT Solution</a>
                    ...
                    <div class="row row2">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <h4 class="card-title">Android Dev</h4>
                                    <p class="card-text">It focuses on building robust, scalable, and user-friendly mobile applications for the Android platform.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <h4 class="card-title">Website Dev</h4>
                                    <p class="card-text">We build responsive, high-performance, and user-friendly websites according to client needs.
                                     </p>
                                </div>
                            </div>
                        </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 text-content">
                    ...
                    <p>Our company specializes in research, brand identity design, Andriod dev, Web dev and graphic
                ...
                <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="text">
                                <h4 class="card-title">Research</h4>
                                <p class="card-text">Research. Jan 1 June 2024</p>
                ...
                <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="text">
                                <h4 class="card-title">Branding</h4>
                                <p class="card-text">Branding 2 June 2024</p>
                                <button>see project</button>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="text">
                                <h4 class="card-title">Android Dev</h4>
                                <p class="card-text">Development. 5 June 2024</p>
                                <button>see project</button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="text">
                                ...
                                <p class="card-text">Web Dev 3 June 2024</p>
                                <button>see project</button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row gy-4">
                        <div class="col-md-6">
                            <div class="info-box">
                                ...
                                <h3>Address</h3>
                                <p>Roorkee,<br>Uttrakhand, 247667</p>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="info-box">
                        ...
                        <div class="col-md-6">
                            <div class="info-box">
                                ...
                                <h3>Email Us</h3>
                                <p>Febtech@gmail.com<br>rahul@gmail.com</p>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="info-box">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-3 col-md-12 col-sm-12">
                    <p class="logo"><i class="bi bi-chat">
                ...
                <div class="col-lg-2 col-md-12 col-sm-12">
                    <p>&copy;2024_Febtech IT Solution</p>
                </div>
